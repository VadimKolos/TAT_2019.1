...
namespace task_DEV2
{
    ...
    public class PhoneticConverter
    {
        ...
        /// </summary>
        private static readonly char[] legalCharacters = { 'а', 'о', 'у', 'ы', 'э', 'я', 'е', 'ё', 'ю', 'и', 'ь', 'ъ',
        ...
        public PhoneticConverter(string inputedWord)
        {
            ...
            for (int i = 0; i < inputedWord.Length; i++)
            {
                ...
                if (!legalCharacters.Contains(inputedWord[i]) || inputedWord.Length < 1 || countOfPlus > 1 || countOfYo > 1)
                {
